...
void tr_torrentCheckSeedLimit(tr_torrent* tor)
{
    ...
    if (tr_torrentIsSeedRatioDone(tor))
    {
        ...
        /*maybe start the script*/
        if (tr_sessionIsTorrentDoneSeedingScriptEnabled(tor->session))
        {
            torrentCallScript(tor, tr_sessionGetTorrentDoneSeedingScript(tor->session));
        }
    }
